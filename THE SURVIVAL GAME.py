...
bb_A1=pygame.image.load(r"C:\Users\Asus\Desktop\THE SURVIVAL GAME\blood_bag - A+.png")
bb_A2=pygame.image.load(r"C:\Users\Asus\Desktop\THE SURVIVAL GAME\blood_bag - A-.png")
bb_B1=pygame.image.load(r"C:\Users\Asus\Desktop\THE SURVIVAL GAME\blood_bag - B+.png")
bb_B2=pygame.image.load(r"C:\Users\Asus\Desktop\THE SURVIVAL GAME\blood_bag - B-.png")
bb_AB1=pygame.image.load(r"C:\Users\Asus\Desktop\THE SURVIVAL GAME\blood_bag - AB+.png")
bb_AB2=pygame.image.load(r"C:\Users\Asus\Desktop\THE SURVIVAL GAME\blood_bag - AB-.png")
bb_O1=pygame.image.load(r"C:\Users\Asus\Desktop\THE SURVIVAL GAME\blood_bag - O+.png")
bb_O2=pygame.image.load(r"C:\Users\Asus\Desktop\THE SURVIVAL GAME\blood_bag - O-.png")
...
bgrn = pygame.image.load(r"C:\Users\Asus\Desktop\THE SURVIVAL GAME\bg22.jpg") #loaded bg image
game_bg = pygame.image.load(r"C:\Users\Asus\Desktop\THE SURVIVAL GAME\game_bg.png")
score_bg1 = pygame.image.load(r'C:\Users\Asus\Desktop\THE SURVIVAL GAME\score_bg1.png')
button_press = pygame.mixer.Sound(r'C:\Users\Asus\Desktop\THE SURVIVAL GAME\Play_button.wav')
...
def player_move(x, y):
    player = pygame.image.load(r"C:\Users\Asus\Desktop\THE SURVIVAL GAME\ambul.png")
...
def welcome():
    ...
    while intro:
        ...
        text_screen("DEVELOPED BY: Akash Kanase ",maroon,18,10,540)
...
def highscore(score,bg):
    ...
    if bg == bloog_grp[0]:
        pygame.mixer.music.load(r'C:\Users\Asus\Desktop\THE SURVIVAL GAME\audio_O1.mp3')
        count = score[2]+score[3]+score[4]+ score[5] + score[6] + score[7]
        if count == 0:
            high_sc = score[0] + score[1]
    elif bg == bloog_grp[1]:
        pygame.mixer.music.load(r'C:\Users\Asus\Desktop\THE SURVIVAL GAME\audio_O2.mp3')
        count = score[0]+score[2] + score[3] + score[4] + score[5] + score[6] + score[7]
        if count == 0:
            high_sc = score[1]
    elif bg == bloog_grp[2]:
        pygame.mixer.music.load(r'C:\Users\Asus\Desktop\THE SURVIVAL GAME\audio_A1.mp3')
        count = score[4] + score[5] + score[6] + score[7]
        if count == 0:
            high_sc = score[0] + score[1] + score[2] + score[3]
    elif bg == bloog_grp[3]:
        pygame.mixer.music.load(r'C:\Users\Asus\Desktop\THE SURVIVAL GAME\audio_A2.mp3')
        count = score[0] + score[2] + score[4] + score[5] + score[6] + score[7]
        if count == 0:
            high_sc = score[1] + score[3]
    elif bg == bloog_grp[4]:
        pygame.mixer.music.load(r'C:\Users\Asus\Desktop\THE SURVIVAL GAME\audio_B1.mp3')
        count = score[2] + score[3] + score[6] + score[7]
        if count == 0:
            high_sc = score[0] + score[1] + score[4] + score[5]
    elif bg == bloog_grp[5]:
        pygame.mixer.music.load(r'C:\Users\Asus\Desktop\THE SURVIVAL GAME\audio_B2.mp3')
        count = score[0] + score[2] + score[3] + score[4] + score[6] + score[7]
        if count == 0:
            high_sc = score[1] + score[5]
    elif bg == bloog_grp[6]:
        pygame.mixer.music.load(r'C:\Users\Asus\Desktop\THE SURVIVAL GAME\audio_AB1.mp3')
        if count == 0:
            high_sc = score[0] + score[1] + score[2] + score[3] + score[4] + score[5] + score[6] + score[7]
    elif bg == bloog_grp[7]:
        pygame.mixer.music.load(r'C:\Users\Asus\Desktop\THE SURVIVAL GAME\audio_AB2.mp3')
...
def draw_bar(score):
    ...
    with open(r'C:\Users\Asus\Desktop\THE SURVIVAL GAME\Blood_grp_data.csv', 'w+') as csvfile:
    ...
    bldgrp = []
    count = []
    with open(r'C:\Users\Asus\Desktop\THE SURVIVAL GAME\Blood_grp_data.csv', 'r') as csvfile:
    ...
    ax.legend()
    fig.savefig(r'C:\Users\Asus\Desktop\THE SURVIVAL GAME\plot.png')
    csvfile.close()
    print(bldgrp)
    print(count)
...
def screen1():
    global exit_game
    disp_screen1 = True
    img_box = pygame.image.load(r'C:\Users\Asus\Desktop\THE SURVIVAL GAME\box_inactive.png')
    active = False
    bg = ''
        ...
        for event in pygame.event.get():
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if mx in range(360, 540) and my in range(400, 494):
                    img_box = pygame.image.load(r'C:\Users\Asus\Desktop\THE SURVIVAL GAME\box_active.png')
                    pygame.mixer.Sound.play(button_press)
                    active = True
                else:
                    continue
...
def screen2(bg):
    global exit_game
    disp_screen2 = True
    play = pygame.image.load(r'C:\Users\Asus\Desktop\THE SURVIVAL GAME\play.png')
    bg_speech = bg
    ...
    pygame.mixer.music.load(r"C:\Users\Asus\Desktop\THE SURVIVAL GAME\Script.mp3")
...
def gameloop():
    ...
    bg = screen1()
    screen2(bg)
    sc=pygame.image.load(r'C:\Users\Asus\Desktop\THE SURVIVAL GAME\score.png')
    x = y = 0
    px = 180
    py = 240
    pos = 0
    ...
    sc_O1 = 0
    sc_O2 = 0
    col_sound = pygame.mixer.Sound(r'C:\Users\Asus\Desktop\THE SURVIVAL GAME\bag_collect.wav')
    pygame.mixer.music.load(r"C:\Users\Asus\Desktop\THE SURVIVAL GAME\ambsund.mp3")
    ...
    if game_over and not exit_game:
        ...
        draw_bar(score)
        score_bg1 = pygame.image.load(r'C:\Users\Asus\Desktop\THE SURVIVAL GAME\score_bg1.png')
        plot = pygame.image.load(r'C:\Users\Asus\Desktop\THE SURVIVAL GAME\plot.png')
        gameDisp.blit(score_bg1, (0, 0))
